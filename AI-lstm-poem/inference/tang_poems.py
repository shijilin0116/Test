...
tf.app.flags.DEFINE_string('file_path', os.path.abspath('./dataset/data/poemsTest.txt'), 'file name of poems.')


tf.app.flags.DEFINE_string('model_prefix', 'poems', 'model save prefix.')

tf.app.flags.DEFINE_integer('epochs', 8, 'train how many epochs.')
